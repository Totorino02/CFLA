...
def run_flhc_femnist(
    nb_runs=1, base_seed=2026, n_clients=50, alpha=0.5, max_samples_per_client=None
):
...
def run_lcfed_femnist(
    nb_runs=1, base_seed=2026, n_clients=50, alpha=0.5, mu=1.0, lam=2.0, max_samples_per_client=None
):
...
def run_fedper_femnist(
    nb_runs=1, base_seed=2026, n_clients=50, alpha=0.5, max_samples_per_client=None
):
    from cfla.framework.client.client_fedper import ClientFedPer
    from cfla.framework.server.server_fedper import ServerFedPer
...
def run_fedgroup_femnist(
    nb_runs=1, base_seed=2026, n_clients=50, alpha=0.5, max_samples_per_client=None
):
    from cfla.framework.client.client_fedgroup import ClientFedGroup
    from cfla.framework.server.server_fedgroup import ServerFedGroup
...
def run_cgpfl_femnist(
    nb_runs=1, base_seed=2026, n_clients=50, alpha=0.5, max_samples_per_client=None
):
    from cfla.framework.client.client_cgpfl import ClientCGPFL
    from cfla.framework.server.server_cgpfl import ServerCGPFL
...
def run_ifca_femnist(
    nb_runs=1, base_seed=2026, n_clients=50, alpha=0.5, max_samples_per_client=None
):
    from cfla.framework.client.client_ifca import ClientIFCA
    from cfla.framework.server.server_ifca import ServerIFCA
